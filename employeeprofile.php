            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="overflow: hidden;">
                       <form action="/action_page.php" id="frm_cat">
  ...
  $("#btn_submit").click(function(){
   ...
   if(employee_id == ""){
    ...
    $("#errors").html(errors);
      ...
      $.ajax({
      type:"POST",
    url:"Employeeprofile/updateuser",
     data:{
      "id":id,
...
$(document).ready(function(){
  $("#btn_pwd").click(function(){
    ...
    errors = "Confirm password is mandatory!";
    $("#pwd_errors").html(errors);
    }
    ...
    $("#pwd_errors").html(errors);
      ...
      $.ajax({
      type:"POST",
    url:"Employeeprofile/updatepassword",
     data:{
      "email":email,
        "password":password
    },
    success:function(response){
      console.log(response);
       errors = "Password successfully updated!";
      $("#pwd_errors").html(errors);
